function [xTest,xTrain,yTrain,yTest,trainF,trainS] = splitData(x,y,frac)
  facultyidic = y == 1;
studentidic = y == 2;
...
testStudRows = studrows(trainS+1:end,:);
  ...
  yTrainS = ones(trainS,1) + 1;
  yTestS = ones(testS,1) + 1;
  yTrainF = zeros(trainF,1) + 1;
  yTestF = zeros(testF,1) + 1;
